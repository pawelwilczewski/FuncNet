...
{public static TResult Combine<TResult, TSuccess0, TSuccess1, TError0>(Result<TSuccess0, TError0> result0,
		Result<TSuccess1, TError0> result1,
		Func<TSuccess0, TSuccess1, TResult> combineSuccess,
		Func<IReadOnlyList<TError0>, TResult> combineErrors){
		var r0 = result0;
			var r1 = result1;
			if (r0.IsSuccess
			&& r1.IsSuccess){
		...
		if (r1.Value.Index == 1) errors0.Add(r1.Value.Value1);
			return combineErrors(errors0);
			
		}

	public static TResult Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TError0>(Result<TSuccess0, TError0> result0,
		Result<TSuccess1, TError0> result1,
		Result<TSuccess2, TError0> result2,
	...
	public static TResult Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TSuccess3, TError0>(Result<TSuccess0, TError0> result0,
		Result<TSuccess1, TError0> result1,
		Result<TSuccess2, TError0> result2,
		Result<TSuccess3, TError0> result3,
	...
	public static TResult Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TSuccess3, TSuccess4, TError0>(Result<TSuccess0, TError0> result0,
		Result<TSuccess1, TError0> result1,
		Result<TSuccess2, TError0> result2,
		Result<TSuccess3, TError0> result3,
		Result<TSuccess4, TError0> result4,
	...
	public static TResult Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TSuccess3, TSuccess4, TSuccess5, TError0>(Result<TSuccess0, TError0> result0,
		Result<TSuccess1, TError0> result1,
		Result<TSuccess2, TError0> result2,
		Result<TSuccess3, TError0> result3,
		Result<TSuccess4, TError0> result4,
		Result<TSuccess5, TError0> result5,
	...
	public static async Task<TResult> Combine<TResult, TSuccess0, TSuccess1, TError0>(Task<Result<TSuccess0, TError0>> result0,
		Task<Result<TSuccess1, TError0>> result1,
		Func<TSuccess0, TSuccess1, Task<TResult>> combineSuccess,
		Func<IReadOnlyList<TError0>, Task<TResult>> combineErrors,
		...
		if (r0.Value.Index == 1) errors0.Add(r0.Value.Value1);
		if (r1.Value.Index == 1) errors0.Add(r1.Value.Value1);
			return await (combineErrors(errors0)).ConfigureAwait(false);
			
		}

	public static async Task<TResult> Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TError0>(Task<Result<TSuccess0, TError0>> result0,
		Task<Result<TSuccess1, TError0>> result1,
		Task<Result<TSuccess2, TError0>> result2,
	...
	public static async Task<TResult> Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TSuccess3, TError0>(Task<Result<TSuccess0, TError0>> result0,
		Task<Result<TSuccess1, TError0>> result1,
		Task<Result<TSuccess2, TError0>> result2,
		Task<Result<TSuccess3, TError0>> result3,
	...
	public static async Task<TResult> Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TSuccess3, TSuccess4, TError0>(Task<Result<TSuccess0, TError0>> result0,
		Task<Result<TSuccess1, TError0>> result1,
		Task<Result<TSuccess2, TError0>> result2,
		Task<Result<TSuccess3, TError0>> result3,
		Task<Result<TSuccess4, TError0>> result4,
	...
	public static async Task<TResult> Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TSuccess3, TSuccess4, TSuccess5, TError0>(Task<Result<TSuccess0, TError0>> result0,
		Task<Result<TSuccess1, TError0>> result1,
		Task<Result<TSuccess2, TError0>> result2,
		Task<Result<TSuccess3, TError0>> result3,
		Task<Result<TSuccess4, TError0>> result4,
		Task<Result<TSuccess5, TError0>> result5,
	...
	public static async Task<TResult> Combine<TResult, TSuccess0, TSuccess1, TError0>(Result<TSuccess0, TError0> result0,
		Result<TSuccess1, TError0> result1,
		Func<TSuccess0, TSuccess1, Task<TResult>> combineSuccess,
		Func<IReadOnlyList<TError0>, Task<TResult>> combineErrors,
		CancellationToken cancellationToken = default){
	...
	public static async Task<TResult> Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TError0>(Result<TSuccess0, TError0> result0,
		Result<TSuccess1, TError0> result1,
		Result<TSuccess2, TError0> result2,
		Func<TSuccess0, TSuccess1, TSuccess2, Task<TResult>> combineSuccess,
		Func<IReadOnlyList<TError0>, Task<TResult>> combineErrors,
	...
	public static async Task<TResult> Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TSuccess3, TError0>(Result<TSuccess0, TError0> result0,
		Result<TSuccess1, TError0> result1,
		Result<TSuccess2, TError0> result2,
		Result<TSuccess3, TError0> result3,
		Func<TSuccess0, TSuccess1, TSuccess2, TSuccess3, Task<TResult>> combineSuccess,
	...
	public static async Task<TResult> Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TSuccess3, TSuccess4, TError0>(Result<TSuccess0, TError0> result0,
		Result<TSuccess1, TError0> result1,
		Result<TSuccess2, TError0> result2,
		Result<TSuccess3, TError0> result3,
		Result<TSuccess4, TError0> result4,
	...
	public static async Task<TResult> Combine<TResult, TSuccess0, TSuccess1, TSuccess2, TSuccess3, TSuccess4, TSuccess5, TError0>(Result<TSuccess0, TError0> result0,
		Result<TSuccess1, TError0> result1,
		Result<TSuccess2, TError0> result2,
		Result<TSuccess3, TError0> result3,
		Result<TSuccess4, TError0> result4,
