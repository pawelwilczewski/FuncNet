...
public static class Union3Bind
{
	...
	public static Union<T0New, T1, T2> Bind0<T0New, T0Old, T1, T2>(
	...
	public static Union<T0, T1New, T2> Bind1<T1New, T0, T1Old, T2>(
	...
	public static Union<T0, T1, T2New> Bind2<T2New, T0, T1, T2Old>(
	...
	public static async Task<Union<T0New, T1, T2>> Bind0<T0New, T0Old, T1, T2>(
	...
	public static async Task<Union<T0, T1New, T2>> Bind1<T1New, T0, T1Old, T2>(
	...
	public static async Task<Union<T0, T1, T2New>> Bind2<T2New, T0, T1, T2Old>(
