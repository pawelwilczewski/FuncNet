...
public static class Union6Bind
{
	...
	public static Union<T0New, T1, T2, T3, T4, T5> Bind0<T0New, T0Old, T1, T2, T3, T4, T5>(
	...
	public static Union<T0, T1New, T2, T3, T4, T5> Bind1<T1New, T0, T1Old, T2, T3, T4, T5>(
	...
	public static Union<T0, T1, T2New, T3, T4, T5> Bind2<T2New, T0, T1, T2Old, T3, T4, T5>(
	...
	public static Union<T0, T1, T2, T3New, T4, T5> Bind3<T3New, T0, T1, T2, T3Old, T4, T5>(
	...
	public static Union<T0, T1, T2, T3, T4New, T5> Bind4<T4New, T0, T1, T2, T3, T4Old, T5>(
	...
	public static Union<T0, T1, T2, T3, T4, T5New> Bind5<T5New, T0, T1, T2, T3, T4, T5Old>(
	...
	public static async Task<Union<T0New, T1, T2, T3, T4, T5>> Bind0<T0New, T0Old, T1, T2, T3, T4, T5>(
	...
	public static async Task<Union<T0, T1New, T2, T3, T4, T5>> Bind1<T1New, T0, T1Old, T2, T3, T4, T5>(
	...
	public static async Task<Union<T0, T1, T2New, T3, T4, T5>> Bind2<T2New, T0, T1, T2Old, T3, T4, T5>(
	...
	public static async Task<Union<T0, T1, T2, T3New, T4, T5>> Bind3<T3New, T0, T1, T2, T3Old, T4, T5>(
	...
	public static async Task<Union<T0, T1, T2, T3, T4New, T5>> Bind4<T4New, T0, T1, T2, T3, T4Old, T5>(
	...
	public static async Task<Union<T0, T1, T2, T3, T4, T5New>> Bind5<T5New, T0, T1, T2, T3, T4, T5Old>(
