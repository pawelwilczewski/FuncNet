...
public static class Union2Bind
{
	...
	public static Union<T0New, T1> Bind0<T0New, T0Old, T1>(
	...
	public static Union<T0, T1New> Bind1<T1New, T0, T1Old>(
	...
	public static async Task<Union<T0New, T1>> Bind0<T0New, T0Old, T1>(
	...
	public static async Task<Union<T0, T1New>> Bind1<T1New, T0, T1Old>(
