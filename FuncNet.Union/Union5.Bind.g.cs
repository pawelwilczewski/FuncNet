...
public static class Union5Bind
{
	...
	public static Union<T0New, T1, T2, T3, T4> Bind0<T0New, T0Old, T1, T2, T3, T4>(
	...
	public static Union<T0, T1New, T2, T3, T4> Bind1<T1New, T0, T1Old, T2, T3, T4>(
	...
	public static Union<T0, T1, T2New, T3, T4> Bind2<T2New, T0, T1, T2Old, T3, T4>(
	...
	public static Union<T0, T1, T2, T3New, T4> Bind3<T3New, T0, T1, T2, T3Old, T4>(
	...
	public static Union<T0, T1, T2, T3, T4New> Bind4<T4New, T0, T1, T2, T3, T4Old>(
	...
	public static async Task<Union<T0New, T1, T2, T3, T4>> Bind0<T0New, T0Old, T1, T2, T3, T4>(
	...
	public static async Task<Union<T0, T1New, T2, T3, T4>> Bind1<T1New, T0, T1Old, T2, T3, T4>(
	...
	public static async Task<Union<T0, T1, T2New, T3, T4>> Bind2<T2New, T0, T1, T2Old, T3, T4>(
	...
	public static async Task<Union<T0, T1, T2, T3New, T4>> Bind3<T3New, T0, T1, T2, T3Old, T4>(
	...
	public static async Task<Union<T0, T1, T2, T3, T4New>> Bind4<T4New, T0, T1, T2, T3, T4Old>(
